<template>
  <div v-if="attendanceDesk" class="attendance__wrapper">
    <table class="attendance__table">
      ...
      <tr v-for="(row, rIndex) in rows" :key="JSON.stringify(row)">
        ...
        <td v-for="(date) in attendanceDesk.dates" :key="JSON.stringify(date)"
...
export class AttendanceTable extends Vue {
  ...
  public attendanceDesk!: AttendanceDesk

  public attendanceState = AttendanceState

  public get rows (): any[] {
    return this.attendanceDesk.students
  }

  public get columns (): string[] {
    return [
      'Name / Last name',
      ...this.attendanceDesk.dates
    ]
  }
